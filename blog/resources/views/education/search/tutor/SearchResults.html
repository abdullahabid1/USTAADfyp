                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="widget-26-job-title">
                                                            <a href="ProfileTutor.html">Jonathan Doe</a>
                                                            <p class=" text-muted time">jonathanMail@gmail.com</p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="widget-26-job-info">
                                                            <p class="type m-0">Full-Time</p>
                                                            <p class="text-muted m-0">in <span class="location">California, UnitedStates</span></p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="widget-26-job-category bg-soft-base">
                                                            ...
                                                            <span>Math, Physics, English</span>
                                                        </div>
                                                    </td>
                                                    <td>
